...
//Data formada pelo usuário é recebida e convertida.
$data = $_POST['data'];
$ddd = strtotime($data);
$data = date('m-d', $ddd);


//Atribui o ano do calendário à variável
$ano = date('Y');


//Manipula a data de nascimento para o ano atual
$data = $ano . '-' . $data;
...
//Separa o dia e o mês do usuário
$diaCliente = date('d', $dddd);
$mesCliente = date('m', $dddd);


//Abre e converte o XML declarado na variável acima.
            ...
            <?php 
                ...
                foreach($xml->signo as $signo0):
                    ...
                    if(($diaCliente >= $diaSignoInicio && $mesCliente == $mesSignoInicio) || ($diaCliente <= $diaSignoFim && $mesCliente == $mesSignoFim)){
                        ...
                        <span>Descrição: <?php echo $signo0->descricao . '</br>';
                    }            
                endforeach;
                echo '</br>'
            ?>
